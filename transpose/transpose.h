...
void transpose_kernel_cpu(double (*A)[N2], double (*B)[N1], FILE *fp);
void transpose_kernel_cpu_collapse(double (*A)[N2], double (*B)[N1], FILE *fp);
void transpose_kernel_gpu(double (*A)[N2], double (*B)[N1], FILE *fp);
void transpose_kernel_gpu_collapse(double (*A)[N2], double (*B)[N1], FILE *fp);
void transpose_kernel_gpu_mem(double (*A)[N2], double (*B)[N1], FILE *fp);
