...
void kernel1_gpu(Node* graph_nodes, bool *graph_mask, bool *updating_graph_mask,
                 bool *graph_visited, int *graph_edges, int *cost, int totalEdges,  
                 FILE *fp);
void kernel1_gpu_mem(Node* graph_nodes, bool *graph_mask, bool *updating_graph_mask,
                 bool *graph_visited, int *graph_edges, int *cost, int totalEdges,  
                 FILE *fp);
bool kernel2_cpu(bool *graph_mask, bool *updating_graph_mask, bool *graph_visited,  
                 bool stop, FILE *fp);
bool kernel2_gpu(bool *graph_mask, bool *updating_graph_mask, bool *graph_visited,  
                 bool stop, FILE *fp);
